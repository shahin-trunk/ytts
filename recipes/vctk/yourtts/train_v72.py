...
def get_dataset(index: int = 1):
    return BaseDatasetConfig(
        ...
        meta_file_train=f"data/audio/manifest/manifest_se_17072023_32b_{EXP_ID}_{index}_ufid.json",
        meta_file_val=f"data/audio/manifest/manifest_se_17072023_32b_eval_{EXP_ID}_{index}_ufid.json",
