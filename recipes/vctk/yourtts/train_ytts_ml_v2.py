...
CHARACTERS = "".join(sorted(
    {' ', 'a', 'b', 'c', 'd', 'e', 'f', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v',
     'w', 'x', 'z', 'æ', 'ç', 'ð', 'ħ', 'ŋ', 'ɐ', 'ɑ', 'ɒ', 'ɔ', 'ɖ', 'ə', 'ɚ', 'ɛ', 'ɜ', 'ɟ', 'ɡ', 'ɣ', 'ɪ', 'ɬ',
     'ɲ', 'ɳ', 'ɹ', 'ɾ', 'ʂ', 'ʃ', 'ʈ', 'ʊ', 'ʋ', 'ʌ', 'ʒ', 'ʔ', 'ʕ', 'ʰ', 'ʲ', 'ˈ', 'ˌ', 'ː', 'ˤ', '̃', '̩', '̪',
     'θ', 'χ', 'ᵻ'}))
...
EXP_ID = "v2_ML"
REF_EXP_ID = "v1_ML"
SPK_EMBEDDING_VERSION = "v5"
PHN_CACHE_VERSION = "v5"
LNG_EMBEDDING_VERSION = "v5"
...
DATASETS_CONFIG_LIST = [
    # get_dataset(manifest_train="manifest_gen_ar_ns_phoneme.json",
    ...
    #             d_name="org",
    #             lang="en"),
    get_dataset(manifest_train="manifest_gen_en_ns_phoneme.json",
...
SPEAKER_ENCODER_CHECKPOINT_PATH = (
    os.path.join(BASE_PATH, "expmt/se/multi/v8/run-August-22-2023_09+48AM-452d4855/checkpoint_105500.pth"))
...
for dataset_conf in DATASETS_CONFIG_LIST:
    ...
    # embeddings_file = os.path.join(SPK_EMB_CACHE_PATH, f"spk_emb_{dataset_conf.dataset_name}.pth")
    ...
    #         disable_cuda=False,
    #         no_eval=False,
    #         ignored_speakers=dataset_conf.ignored_speakers
    #     )
