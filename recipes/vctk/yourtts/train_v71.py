...
def get_dataset(index: int = 1):
    return BaseDatasetConfig(
        ...
        meta_file_train=f"data/audio/manifest/manifest_se_17072023_32b_{index}_ufid.json",
        meta_file_val=f"data/audio/manifest/manifest_se_17072023_32b_eval_{index}_ufid.json",
...
SPEAKER_ENCODER_CHECKPOINT_PATH = (
    "/data/asr/workspace/audio/tts/models/ytts/se/se_model.pt"
)
...
model_args = VitsArgs(
    ...
    hidden_channels=200,
    hidden_channels_ffn_text_encoder=800,
