...
RESTORE_PATH = "/data/asr/workspace/audio/tts/models/ytts/v8/checkpoint_425000.pth"
...
IIAI_DATASET_PATH = "/data/asr/workspace/audio/tts/data/all_speakers_44k"
...
iiai_config = BaseDatasetConfig(
    ...
    meta_file_train="manifest_orig_6_spk.json",
    meta_file_val="manifest_orig_6_spk_eval.json",
...
for dataset_conf in DATASETS_CONFIG_LIST:
    ...
    embeddings_file = os.path.join(dataset_conf.path, f"speakers_{EXP_ID}.pth")
...
model_args = VitsArgs(
    ...
    out_channels=1025,
    num_layers_flow=6,
    hidden_channels_ffn_text_encoder=784,
