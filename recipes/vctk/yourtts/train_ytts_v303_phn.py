...
EXP_ID = "v303_PHN"
SPK_EMBEDDING_VERSION = "v4"
PHN_CACHE_VERSION = "v2"
DATA_ID = "v107"
...
RESTORE_PATH = os.path.join(BASE_PATH,
                            "expmt/ytts/v301_PHN/YTTS-AR-IIAI-August-11-2023_12+00PM-452d4855/best_model.pth")
...
def get_dataset(index: int = 1, data_id: str = None):
    return BaseDatasetConfig(
        ...
        path=BASE_PATH,
        language="ar",
        ignored_speakers=["spk_g_2", "spk_g_3"]
    )
...
SPEAKER_ENCODER_CHECKPOINT_PATH = (
    os.path.join(BASE_PATH, "expmt/se/ar/v7/run-August-12-2023_05+55PM-452d4855/checkpoint_134000.pth"))
SPEAKER_ENCODER_CONFIG_PATH = os.path.join(BASE_PATH, "expmt/se/ar/v7/run-August-12-2023_05+55PM-452d4855/config.json")
