...
RESTORE_PATH = "/data/asr/workspace/audio/tts/models/vits/ar/model_12f.pt"
...
def get_dataset(index: int = 1):
    return BaseDatasetConfig(
        ...
        meta_file_train=f"data/audio/manifest/{EXP_ID}/manifest_{index}_32b_{NUM_SPEAKERS}spk_{SAMPLE_RATE}sr.json",
        meta_file_val=f"data/audio/manifest/{EXP_ID}/manifest_{index}_32b_{NUM_SPEAKERS}spk_{SAMPLE_RATE}sr_eval.json",
        path=BASE_PATH,
        language="ar",
    )
...
vits_args = VitsArgs(
    ...
    hidden_channels=258,
    hidden_channels_ffn_text_encoder=1032,
)
