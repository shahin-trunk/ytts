...
RESTORE_PATH = "/data/asr/workspace/audio/tts/expmt/vits/v91/vits_iiai-July-31-2023_02+59PM-452d4855/best_model_1337457.pth"
MAX_AUDIO_LEN_IN_SECONDS = 28
...
vits_args = VitsArgs(
    ...
    use_sdp=False,
    out_channels=1025,
    upsample_initial_channel_decoder=1024,
    upsample_rates_decoder=[8, 8, 4, 2],
    upsample_kernel_sizes_decoder=[16, 16, 8, 4],
    # length_scale=1.1,
